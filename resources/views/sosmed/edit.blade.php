...
<div class="row">
    <div class="col-xl-6">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
            <h2>Edit <span class="fw-300"><i>{{$sosmed->sosmed}}</i></span></h2>
                <div class="panel-toolbar">
                    <a class="nav-link active" href="{{route('sosmed.index')}}"><i class="fal fa-arrow-alt-left">
                        </i>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    {!! Form::open(['route' => ['sosmed.update',$sosmed->uuid],'method' => 'PUT','class' =>
                    'needs-validation','novalidate']) !!}
                    <div class="form-group col-md-4 mb-3">
                        {{ Form::label('sosmed','Jenis Social Media',['class' => 'required form-label'])}}
                        {!! Form::select('sosmed', array('instagram' => 'Instagram', 'whatsapp' => 'Whatsapp', 'facebook' => 'Facebook'), $sosmed->sosmed,
                        ['id'=>'sosmed','class'
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::text('name', $sosmed->name,['placeholder' => 'Name','class' => 'form-control '.($errors->has('name') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
                        @if ($errors->has('name'))
