...
<div class="row">
    <div class="col-xl-6">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
            <h2>About <span class="fw-300"><i>Us</i></span></h2>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    <div class="form-group col-md-10 mb-20">
                        ...
                        {{ Form::textarea('keterangan', $about->keterangan,['placeholder' => 'Keterangan','class' => 'form-control '.($errors->has('keterangan') ? 'is-invalid':''),'required', 'autocomplete' => 'off', 'rows' => '20', 'id' => 'mytextarea'])}}
