...
<div class="row">
    <div class="col-xl-6">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
            <h2>Edit <span class="fw-300"><i>{{$wisma->name}}</i></span></h2>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    {!! Form::open(['route' => ['wisma.update',$wisma->uuid],'method' => 'PUT','class' =>
                    'needs-validation','novalidate', 'enctype' => 'multipart/form-data']) !!}
                    <div class="form-group col-md-4 mb-3">
                        {{ Form::label('name','Wisma Name',['class' => 'required form-label'])}}
                        {{ Form::text('name',$wisma->name,['placeholder' => 'Wisma Name','class' => 'form-control '.($errors->has('name') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
                        @if ($errors->has('name'))
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::textarea('address',$wisma->address,['placeholder' => 'Address','class' => 'form-control '.($errors->has('address') ? 'is-invalid':''),'required', 'autocomplete' => 'off', 'rows' => '5'])}}
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::text('telephone',$wisma->telephone,['placeholder' => 'Telephone','class' => 'form-control '.($errors->has('telephone') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        <input type="hidden" name="oldImage" value="{{ $wisma->photo }}"> 
                        @if ($wisma->photo)
                            <img src="{{ asset('photo/' . $wisma->photo) }}" class="img-preview img-fluid mb-3 col-sm-5 d-block">
                        @else
